...
#### [Location and Wayfinding with Mapwize](https://github.com/IndoorLocation/meraki-indoor-location)

This set of tools will help you to quickly deploy Indoor Location form Meraki with Indoor Maps and Wayfinding from [Mapwize](https://www.mapwize.io). Both the location scanning API and the iBeacons capabilities are supported. The indoor map of the entire conference, including the hackathon area are available and can be added to your app in a few lines of code. [Mathieu Gerard](mailto:mathieu@mapwize.io) from Mapwize will be on site to answer all your questions.

![](docs/img/mapwize.png)
